...
_SEED_DECISIONS = [
    ...
    {"id": "dec-realtime-traillog", "owner_id": "sprint0-sse", "domain": "backend",
     "recommendation": "Prefer managed push + polling over self-hosted WebSocket fan-out on flaky field connectivity",
     "reasoning": "Lesson from the TrailLog field rollout.", "context_tags": ["realtime", "websocket", "polling"],
     "project_id": "seed-traillog",
    ...
    {"id": "dec-payments-quantapay", "owner_id": "sprint0-sse", "domain": "backend",
     "recommendation": "Stripe Connect for marketplace payouts, idempotent webhooks", "reasoning": "Shipped in QuantaPay.",
     "context_tags": ["payments", "stripe", "webhooks", "idempotency"],
     "project_id": "seed-quantapay", "project_name": "QuantaPay (2024)", "issue_ids": [],
